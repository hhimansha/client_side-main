...
const App = () => {
  ...
  return (
    <Router>
      ...
      {/* <Snowfall /> */}
      <Navbar home = "/" aboutus = "/user/aboutus" communityDetails = "/user/communityDetails" events = "/user/events" contactUs = "/user/contactus" gallery = "/user/gallery" login = "/user/login" news="/user/news" upcomingEvents="/user/upevents" pastEvents="/user/pastevents"  />
      <Routes>
